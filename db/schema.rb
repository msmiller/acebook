...
ActiveRecord::Schema[7.0].define(version: 2023_05_22_060500) do
  ...
  create_table "flaggings", force: :cascade do |t|
    ...
    t.index ["item_type", "item_id"], name: "index_flaggings_on_item"
    t.index ["type"], name: "index_flaggings_on_type"
